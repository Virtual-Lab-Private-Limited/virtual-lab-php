						...
						<div class="row">
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
								<div class="section-header-breadcrumb-content">
									<h1>Doctors List  <?php echo $session_role; ?> </h1>
								</div>
							</div>
						</div>
					</div>
...
<th>Action</th>
                        ...
                        <tbody>
<?php
$doctors=mysqli_query($con,"select * from  frenchise_doctor where labid='$session_labid' order by id desc") or die (mysqli_error($con));
...
<a href="<?php echo $baseurl;?>doctor/<?php echo $info['id'];?>.html" class="btn btn-info"><i class="fa fa-edit"></i> Info </a>
</td>
                          </tr>
<?php
}
