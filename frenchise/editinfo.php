...
$id=$_GET['id'];
$medicines=mysqli_query($con,"select * from culture_info where id='$id' limit 1") or die (mysqli_error());
...
mysqli_query($con,"update culture_info set title='$title' where id='$mid' limit 1 ") or die (mysqli_error($con));
$pid=mysqli_insert_id($con);

header("location:".$baseurl."add_culture/".$c_id.".html");
        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12">
           <div class="section-body">
<form method="post" action="<?php echo $baseurl;?>editinfo/<?php echo $id;?>.html">
        <div class="row">
