...
$message='<font color="red">Both Passwords are not Matched</font>';	
	...
	$query1=mysqli_query($con,"SELECT * from frenchises WHERE username='$username' AND  email='$email'  LIMIT 1") or die (mysqli_error());
	...
	if($count_query1==0 && $count_query2==0){
	    ...
	    $npass=md5($newpass);
          if ($count_query1 > 0) {
            ...
            mysqli_query($con,"update frenchises set 
