                    		...
                    		<div class="invoice-title">
		                      <div class="login-invoice login-invoice-color">
                                  ...
                                  if ($session_outsource == "1") {?>
                                    <img alt="image" src="https://virtuallab.com.pk/<?php echo $session_logo;?>"  width="150"/>
                                  <?php } else { ?> 
                               		<img alt="image" src="<?php echo $baseurl.$basepath;?>images/logo.png" width="150" />
                                  <?php } ?>
                                  </div>
		            			</div>
                    	</div>
...
<li align="left"><strong>Address: </strong>
<?php 
                                  if ($session_outsource == "1") {?>
                                  <?php echo $session_address;?>
                                  </li>
<li align="left"><strong>Ph: <?php echo $session_contact;?></strong></li>
                                  <?php } else { ?> 
                             14-E Maulana Shaukat Ali Rd, Block E Phase 1 Johar Town, Lahore, Punjab
                             </li>
