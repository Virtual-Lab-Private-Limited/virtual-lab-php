...
values( '$firstname','$lastname','$username','$email','$contact','$dob','$password','$role','$status','$doj','$qualification','$salary','$city','$cnic','$session_id','','','N/A','N/A','Not Set','')") or die (mysqli_error($con));
