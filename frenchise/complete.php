                      ...
                      <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                        ...
                        <tbody>
                          ...
                          while ($info = mysqli_fetch_array($bookings)) {
                            ...
                            $books = mysqli_query($con, "select *  from bookings where id='" . $info['bid'] . "'  limit 1") or die(mysqli_error($con));
                          ...
                          ?>
                            <tr>
                              ...
                              <td><?php
                                  $patients = mysqli_query($con, "select *  from patients where id='" . $info['pid'] . "'  limit 1") or die(mysqli_error($con));
                              ...
                              <td><?php
                                  $tests = mysqli_query($con, "select *  from tests where id='" . $info['tid'] . "'  limit 1") or die(mysqli_error($con));
                              ...
                              <td width="25%">
                                ...
                                if ($type == 'radiology_home' || $type == 'radiology_lab') {  ?>
                                  ...
                                  <a href="<?= $baseurl ?>../<?php echo $info['image']; ?>" target="_blank" class="btn btn-info"><i class="fa fa-print"></i></a>
                                <?php  } else { ?>
                                  <a href="<?php echo $baseurl; ?>edit_report.php?id=<?php echo $info['id']; ?>" class="btn btn-success"><i class="fa fa-pencil-alt"></i></a>
                                  <a href="<?= $baseurl ?>../reports/pdf.php?id=<?php echo $info['id']; ?>" target="_blank" class="btn btn-info"><i class="fa fa-print"></i></a>
