...
$query_tests=mysqli_query($con,"select * from medicines where title='$title' limit 1") or die (mysqli_error());
...
mysqli_query($con,"insert into medicines(title) values ('$title')") or die (mysqli_error($con));
