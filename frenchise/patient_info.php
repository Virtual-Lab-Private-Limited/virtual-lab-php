...
if( ! empty($name)) {
  ...
  mysqli_query($con,"update patients set firstname='$fname',lastname='$lname',cnic='$ncnic',contact='$phone',address='$address', city='$ncity', gender='$gender', dob='$dob',age='$age',blood_group='$bloodgroup',profile='images/$name'  where id='$uid' limit 1") or die (mysqli_error($con));
	$message='<font color="green">Patient has been added successfully</font>';

} else {
    mysqli_query($con,"update patients set firstname='$fname',lastname='$lname',cnic='$ncnic',contact='$phone',address='$address', gender='$gender', city='$ncity',dob='$dob',age='$age',blood_group='$bloodgroup' where id='$uid' limit 1") or die (mysqli_error($con));
	$message='<font color="green">Patient has been added successfully</font>';
...
<input type="text" class="form-control" name="city" value="<?php echo $city;?>">
                    ...
                    <div class="form-group">
<label style="margin-right:5%">DOB</label><?php echo $dob;?> <label style="margin-right:5%;margin-left:5%">Age</label><?php echo $age;?>
<div class="input-group">
<div class="input-group-prepend">
<div class="input-group-text">
