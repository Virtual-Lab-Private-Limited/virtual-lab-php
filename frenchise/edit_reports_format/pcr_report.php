...
$a = 1;
$bookings = mysqli_query($con, "select * from pcr_result where bid='$bid'") or die(mysqli_error());
while ($booking = mysqli_fetch_array($bookings)) {
  ...
  <div class="form-group" style="padding: 5%; text-align:left"> <?php echo $remarks; ?>                   </div>
            <div class="form-group">
<input type="submit" name="pcr" class="btn btn-block btn-info" value="Update">                    </div>
                  </div>
              </div>
</div>
</form>