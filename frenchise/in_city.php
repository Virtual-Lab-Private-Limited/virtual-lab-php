...
$id = $_GET['id'];
mysqli_query($con,"update in_city_requests set resolve=1 where id='$id' ") or die (mysqli_error($con));
...
<td width="14%">
<a href="<?php echo $baseurl;?>in_city.php?id=<?php echo $info['id'];?>" class="btn btn-success">Resolve</a>
</td>
                          </tr>
<?php
}
