              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header" style="padding-left:50%">
                      <form method="POST" action="<?php echo $baseurl;?>update_doctor_ledger.php?id=<?php echo $id;?>" >
...
if(isset($_POST['from'])){
    ...
    $earnings=mysqli_query($con,"select * from  doctor_earnings where cc_id=0 and labid='$session_labid' and doctor_id='$id' and date between '$from' and '$to' order by id desc") or die (mysqli_error($con));

    
} else{
    $earnings=mysqli_query($con,"select * from  doctor_earnings where cc_id=0 and labid='$session_labid' and doctor_id='$id'  order by id desc") or die (mysqli_error($con));
...
<td width="14%">
<?php if  ($info['paid'] == 0){ ?>
<a href="<?php echo $baseurl;?>update_doctor_ledger.php?id=<?php echo $info['id'];?>&d_id=<?php echo $id;?>" class="btn btn-success">Resolve </a>
