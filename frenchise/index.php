...
if (isset($_POST['submit'])) {
  ...
  if ($count_cnic > 0) {
    ...
    mysqli_query($con, "insert into patients (firstname,lastname,cnic,contact,address,city,dob,age,blood_group,date_entry,gender,labid,addby,parentid)
values('$firstname','$lastname','$cnic','$contact','$address','$city','$dob','$age','$blood_group',now(),'$gender','$session_labid','$session_id','0')") or die(mysqli_error($con));
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        <select class="form-control select2" name="city" required>
                          ...
                          <?php
                          $types = mysqli_query($con, "select * from cities") or die(mysqli_error($con));
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                        ...
                        <tbody>
                          <?php
                          $staff_members = mysqli_query($con, "select * from patients where labid='$session_labid' order by date_entry asc") or die(mysqli_error($con));
