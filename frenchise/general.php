...
<input type="text" class="form-control" name="google" placeholder="Google Analytics" value="<?php echo $google;?>" >
</div>
              </div>
        <div class="form-group">
<label>PHC Number</label>
<div class="input-group">
                  <div class="input-group-addon">
                    <i class="fa fa-google"></i>
                  </div>
<input type="text" class="form-control" name="phc" placeholder="PHC Number" value="<?php echo $phc;?>" >
</div>
              </div>
