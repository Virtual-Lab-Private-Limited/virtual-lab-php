...
Virtual Lab';
    ...
    $params = [
      'transaction_id' => $transaction_id, 'user' => 'virtullab', 'pass' => 'SS123',
                          ...
                          <td width="25%">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a href="<?php echo $baseurl; ?>home.html?status=accept&bid=<?php echo $bid; ?>&id=<?php echo $info['id']; ?>&bno=<?php echo $bookingno; ?>&contact=<?php echo $contact; ?>&name=<?php echo $name; ?>&test=<?php echo $t; ?>&pid=<?php echo $pid; ?>" class="dropdown-item">Approve</a>
                                <a href="<?php echo $baseurl; ?>home.html?status=reject&bid=<?php echo $bid; ?>&id=<?php echo $info['id']; ?>" class="dropdown-item">Reject</a>
                                <a href="<?php echo $baseurl; ?>home.html?contact=<?php echo $contact; ?>&name=<?php echo $name; ?>&test=<?php echo $t; ?>" class="dropdown-item">Send SMS</a>
                              </div>
                            </div>
                          </td>
                        </tr>
