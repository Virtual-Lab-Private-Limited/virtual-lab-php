...
mysqli_query($con,"insert into tests(pid,gid,catid,organid,disid,title,slug,sample,price,cost,remarks,type,unit,gender,batch_day,duration,discount_type) values ('$pid','$gid','$catid','$organid','$disid','$title','$url','$sample','$price','$cost','$remakrs','$test_type','$unit','$gender','$batch_day','$duration','$discount_type')") or die (mysqli_error($con));
...
<td width="25%">
    ...
    <select class="form-control" onChange="window.location.href=this.value" >
        ...
        <option href="<?php echo $baseurl;?>groups.php?id=<?php echo $info['id'];?>"  class="btn btn-primary"> Add Groups</option>
