...
if (isset($_POST['submit'])) {
    ...
    test_status, pass_no, flight_no, flight_date, ticket_no, discount_type, cc_no)value('$caseno','$uid','$tcost','$discount','$tprice','1','pending','$today','Staff',
...
<th>Action</th>
                        ...
                        <tbody>
<?php
$staff_members = mysqli_query($con, "select * from tests order by id asc") or die(mysqli_error($con));
