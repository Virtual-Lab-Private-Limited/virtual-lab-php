...
<?php 
$results = mysqli_query($con, "select * from  pcr_qualitative_result where bdid='$report_id' order by priority asc  ") or die(mysqli_error());
...
<tr>
<th class="text-left" width="80%">Test</th>
<th class="text-left" width="20%">Results</th>
</tr>
...
while ($row = mysqli_fetch_array($results)) {
    ...
    ?>
<tr>
        <td class="text-left" width="80%"><?php echo $test_title; ?></td>
        <td class="text-left" width="20%"><?php echo $row['result']; ?></td>
</tr>
<?php }?>
