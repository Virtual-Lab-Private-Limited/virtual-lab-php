...
function arrived($rider_id, $data, $con)
{
    ...
    try {
        ...
        mysqli_query($con, "update booking_rider set status='arrived' where bid='$booking_id'") or die(mysqli_error($con));
        
        $runtime_status = "Phlebotomist arrival at home at " . date("d m Y h:i:s A");
