...
if ($auth->isAuth()) {
    ...
    $returnData = acceptRide($rider_id, $data, $conn);
...
function acceptRide($rider_id, $data, $con)
{
    ...
    try {
        ...
        mysqli_query($con, "update booking_rider set rid='$rider_id', status='accepted' where bid='$booking_id'") or die(mysqli_error($con));
