...
elseif(!isset($data->firstname) 
    ...
    $fields = ['fields' => ['firstname','lastname','cnic','password','gender','contact','city','dob', 'device_id', 'address']];
...
// IF THERE ARE NO EMPTY FIELDS THEN-
    ...
    if(strlen($cnic) < 13):
        $returnData = msg(0,422,'Invalid Cnic. Must be valid 13 digits!');
        ...
        try{
            ...
            if($check_cnic_stmt->rowCount()){
                ...
                if($check_contact_stmt->rowCount()){
                    $returnData = msg(0,422, 'This Contact already in use!');}
