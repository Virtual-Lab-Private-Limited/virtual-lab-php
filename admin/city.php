...
$query_tests=mysqli_query($con,"select * from cities where city='$title' limit 1") or die (mysqli_error());

$count_test=mysqli_num_rows($query_tests);
if($count_test>0){
$message='<font color="red"><p align="center">The Following City already exist</p></font>';	
}else{

mysqli_query($con,"insert into cities (city) values ('$title')") or die (mysqli_error($con));
$pid=mysqli_insert_id($con);

$message='<font color="green"><p align="center">City has been added successfully</p>
</font>
'; 
...
<head>
  ...
  <title>Cities List | <?php echo $basetitle;?></title>
  <!-- General CSS Files -->
        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="row">
                 ...
                 <form method="post" action="<?php echo $baseurl;?>city.php">
                             <h3>Add City</h3> 
...
<input type="text" class="form-control" name="title" value="">
                    ...
                    <div class="form-group">
<div class="form-group"><input type="submit" value=" Add City " class="btn btn-block btn-info"></div>
                    </div>
...
<th>Action</th>
                        ...
                        <tbody>
<?php
$tests=mysqli_query($con,"select * from cities order by id") or die (mysqli_error());
...
<a href="<?php echo $baseurl;?>deletecity.php?id=<?php echo $info['id'];?>" class="btn btn-danger">Delete</a>
                            </td>
                          </tr>
<?php
}
