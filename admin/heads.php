...
$query_tests=mysqli_query($con,"select * from test_heads where title='$title' and tid='$catid' limit 1") or die (mysqli_error());

$count_test=mysqli_num_rows($query_tests);
if($count_test>0){
$message='<font color="red"><p align="center">The Following Test Head is already Exist with the following Test</p></font>';	
}else{

mysqli_query($con,"insert into test_heads(title,tid) values ('$title','$catid')") or die (mysqli_error($con));
$pid=mysqli_insert_id($con);

$message='<font color="green"><p align="center">Your Test Head has been added successfully</p>
</font>
'; 
...
<head>
  ...
  <title>Test Head List | <?php echo $basetitle;?></title>
  <!-- General CSS Files -->
        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12">
           <div class="section-body">
<form method="post" action="<?php echo $baseurl;?>heads/<?php echo $id;?>.html">
        <div class="row">
...
<th>Action</th>
                        ...
                        <tbody>
<?php
$tests=mysqli_query($con,"select * from test_heads where tid='$id' order by id") or die (mysqli_error($con));
