...
$query_tests=mysqli_query($con,"select * from discounts where title='$title' limit 1") or die (mysqli_error($con));
        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12">
           <div class="section-body">
<form method="post" action="<?php echo $baseurl;?>discounts.html">
        <div class="row">
...
<th>Edit</th>
                        ...
                        <tbody>
<?php
$tests=mysqli_query($con,"select * from discounts order by id") or die (mysqli_error());
