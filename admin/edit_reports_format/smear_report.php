...
$bookings = mysqli_query($con, "select * from smear_result where bid='$bid'") or die(mysqli_error());
...
<div class="form-group" style="padding: 5%; text-align:left"> <?php echo $remarks; ?>                   </div>
            ...
            <div class="form-group">
<input type="submit" name="smear" class="btn btn-block btn-info" value="Update">                    </div>
                  </div>
              </div>
</div>
</form>