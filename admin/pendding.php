...
$books=mysqli_query($con,"select b.*  from bookings as b join booking_details as d on b.id=d.bid where d.status='pending'  group by b.bookingno order by b.id desc  ") or die (mysqli_error());
...
<td>
<a href="<?php echo $baseurl;?>patient_tests/<?php echo $bid;?>" class="btn btn-info">Tests</a>
                            </td>
