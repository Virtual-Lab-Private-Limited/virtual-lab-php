...
$id=$_GET['id'];
if (isset($id)){
mysqli_query($con,"delete from vouchers where id='$id' ") or die (mysqli_error());
...
<head>
  ...
  <title>Voucher | <?php echo $basetitle;?></title>
  <!-- General CSS Files -->
...
<th width="5%">Uses Till Date</th>
<th width="5%">Maximum Uses allowed</th>
...
<th>Actions</th>
                        ...
                        <tbody>
<?php
$packages=mysqli_query($con,"select * from vouchers order by id") or die (mysqli_error($con));
...
<td><?php echo $info['uses'];?></td>
<td><?php echo $info['max_uses'];?></td>
<td width="30%"><?php echo $info['description'];?></td>
<td >
    <div class="row">
        <div class="col-md-4">
            <a href="<?php echo $baseurl.'vouchers.php?id='.$info['id'];?>" class="btn btn-warning">Delete</a>
        </div>
        <div class="col-md-4"><a href="<?php echo $baseurl.'edit_voucher.php?id='.$info['id'];?>" class="btn btn-success">Edit</a></div>
    </div>
