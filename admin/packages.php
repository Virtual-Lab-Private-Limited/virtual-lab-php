...
<td width="40%">
    <div class="row">
        <div class="col-md-4"><a href="<?php echo $baseurl;?>pack/<?php echo $info['id'];?>.html" class="btn btn-info">Add Test</a>
</div>
        <div class="col-md-4"><a href="<?php echo $baseurl.'edit_package.php?id='.$info['id'];?>" class="btn btn-success">Edit</a>
</div>
        <div class="col-md-4"><a href="<?php echo $baseurl.'delete_package.php?id='.$info['id'];?>" class="btn btn-danger">Delete</a>
</div>
    </div>
