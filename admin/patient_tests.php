...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    mysqli_query($con,"update booking_details set status='Complete', runtime_status='Report generated', labid='$session_labid', result_date='$today', image='$p' where id='$bdid' limit 1 ") or die (mysqli_error($con));
