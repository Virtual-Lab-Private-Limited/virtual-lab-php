...
<th class="none">Proof</th>
 ...
 <th width="5%">Actions</th>                         </tr>
                        ...
                        <tbody>
<?php
$bookings=mysqli_query($con,"select * from bookings where addby='Patient' order by test_date desc") or die (mysqli_error());
...
<td width="5%">
 ...
 Actions
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a href="<?php echo $baseurl;?>onlinebookings.php?did=<?php echo $info['id'];?>&bno=<?php echo $info['bookingno'];?>" class="dropdown-item">Delete Booking</a>
