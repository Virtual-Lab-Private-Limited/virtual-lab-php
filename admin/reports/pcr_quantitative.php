...
<?php 
$results = mysqli_query($con, "select * from  pcr_quantitative_result where bdid='$report_id' order by priority asc ") or die(mysqli_error());
...
<tr>
<th class="text-left" width="47%">Test</th>
<th class="text-left" width="15%">Viralload</th>
...
while ($row = mysqli_fetch_array($results)) {
    ...
    ?>
<tr>
        <td class="text-left" width="47%"><?php echo $test_title; ?></td>
        <td class="text-left" width="15%"><?php echo $row['viralload']; ?></td>
        <td class="text-left" width="15%"><?php echo $unit; ?></td>
        <td class="text-left" width="10%"><?php echo $row['result']; ?></td>
</tr>
<?php }?>
