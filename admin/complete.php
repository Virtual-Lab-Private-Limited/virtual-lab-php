...
<th>Status</th>
                        ...
                        <tbody>
<?php
$bookings=mysqli_query($con,"select d.* from booking_details as d join bookings as b on d.bid = b.id where d.status='complete'  order by b.id desc") or die (mysqli_error($con));
