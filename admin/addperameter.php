...
<?php include("includes/leftnavigation.php");?>      <!-- Main Content -->
 ...
 <form action="<?php echo $baseurl;?>addperameters/<?php echo $id;?>.html" method="post">             
                      <div class="row">
...
?>
                          <tr>
<td><?php
$heads=mysqli_query($con,"select * from test_heads where id='".$info['headid']."' limit 1") or die (mysqli_error($con));
while($h=mysqli_fetch_array($heads)){
echo $h['title'];	
}
?></td>
