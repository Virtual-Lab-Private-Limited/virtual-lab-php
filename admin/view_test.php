...
<option value="Both">Both</option>
                     ...
                     <select name="type" class="form-control">
                        ...
                        <?php } else if ($test_type == "radiology_home"){ ?> 
                          <option value="radiology_home">Radiology Home</option>
                        <?php } else if ($test_type == "radiology_lab"){ ?> 
                          <option value="radiology_lab">Radiology Lab</option>
                        <?php } else if ($test_type == "eliza"){ ?> 
                          <option value="eliza">Eliza</option>
                        <?php } else if ($test_type == "histopathology"){ ?> 
                        <option value="histopathology ">Histopathology </option>
                        <?php } else if ($test_type == "cross_match_eliza"){ ?> 
                        <option value="cross_match ">Cross Match Eliza</option>
                        <?php } else if ($test_type == "cross_match_screening"){ ?> 
                        <option value="cross_match ">Cross Match Screening</option>
                    ...
                    <div class="form-group">
                      <textarea name="information" class="form-control" placeholder="Other Information.."><?php echo $information;?></textarea>
                    </div>
...
<input type="text" class="form-control" name="batch_day" value="<?php echo $batch_day;?>">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
	                    <div class="form-group">
	                      <label>Remarks</label>
<textarea name="remarks"  class="ckeditor" ><?php echo $test_remarks;?></textarea>
	                    </div>
	                                            <div class="form-group">
...
<?php
if( $goid>0 ) {
$group = mysqli_query($con,"select * from tests where id= $goid  ") or die (mysqli_error($con));
while($ginfo=mysqli_fetch_array($group)){
    echo $ginfo['title'];
}}
?>
</td>
