...
$id=$_GET['id'];
$query_tests=mysqli_query($con,"select * from categories where id='$id' limit 1") or die (mysqli_error($con));
...
mysqli_query($con,"update categories set category='$title', slug='$url' where id='$catid' limit 1") or die (mysqli_error($con));
...
<head>
  ...
  <title>Catgory Info | <?php echo $basetitle;?></title>
  <!-- General CSS Files -->
        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12">
           <div class="section-body">
<form method="post" action="<?php echo $baseurl;?>category/<?php echo $id;?>.html">
        <div class="row">
...
<input type="hidden" class="form-control" name="catid" value="<?php echo $id;?>">
                                          ...
                                          <div class="form-group">
<input type="submit" class="btn btn-block btn-info" value=" Update Category ">                    </div>
