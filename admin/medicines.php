...
$culture_id=mysqli_real_escape_string($con,$_POST['culture_id']);

$query_tests=mysqli_query($con,"select * from medicines where title='$title' and culture_id='$culture_id' limit 1") or die (mysqli_error());

$count_test=mysqli_num_rows($query_tests);
if($count_test>0){
$message='<font color="red"><p align="center">The Following Medicines is already Exist</p></font>';	
}else{

mysqli_query($con,"insert into medicines (title, culture_id) values ('$title', '$culture_id')") or die (mysqli_error($con));
$pid=mysqli_insert_id($con);

$message='<font color="green"><p align="center">Your Medicine has been added successfully</p>
</font>
'; 
        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12">
           <div class="section-body">
<form method="post" action="<?php echo $baseurl;?>medicines.html">
        <div class="row">
...
<option value="" selected>Select Growth</option>
<?php
...
?>
                    ...
                    <div class="form-group">
<div class="form-group">
<input type="submit" value=" Add Medicine " class="btn btn-block btn-info">                    </div>
...
<a href="<?php echo $baseurl;?>deletemedicine.php?id=<?php echo $info['id'];?>" class="btn btn-danger">Delete</a>
                            </td>
                          </tr>
<?php
}
