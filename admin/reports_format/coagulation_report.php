...
<input type="hidden" name="bdid" value="<?php echo $id; ?>" class="form-control">
 ...
 <div class="col-12 col-md-12 col-lg-12">
                 ...
                 <div class="col-md-12">
                    <div class="table-responsive">
                      <table class="table table-striped table-hover table-md">
                          ...
                          if ($count_sub > 0) {
                              ...
                              while ($ref = mysqli_fetch_array($level2)) {
                                  ...
                                  $unit = $ref['unit'];
                                    ...
                                    $db_results = mysqli_query($con, "select * from coagulation_result where bdid='$id' and testid='$testid' ") or die(mysqli_error());
                        ...
                        <td class="text-right" width="15%" ><?php echo $unit; ?></td>
                        <td class="text-center"><input type="number" name="control[]" class="form-control" value="<?php echo $control; ?>"></td>            
                        <td class="text-center"><input type="number" name="result[]" class="form-control" value="<?php echo $value; ?>" ></td>
                        <input type="hidden" name="tid[]" value="<?php echo $testid; ?>" class="form-control">

                        </tr>
                        <?php }} else {
                            
                    $db_results = mysqli_query($con, "select * from coagulation_result where bdid='$id' and testid='$tid' ") or die(mysqli_error());
                    $count_results = mysqli_num_rows($db_results);
                    $value = '';
                    $control = '';
                    if($count_results > 0) {
    ...
    ?>
                        ...
                        <td><input type="number" name="control[]" class="form-control" value="<?php echo $control; ?>"></td>  
                       <td><input type="number"  name="result[]"  class="form-control" value="<?php echo $value; ?>"></td>
...
<input type="submit" name="coagulation" class="btn btn-block btn-info" value="Save">                   
<div style="text-align:right; margin-top:2%"><input type="submit" name="publish_coagulation" value="Conducted Test" class="btn btn-warning">  
                      </div>
