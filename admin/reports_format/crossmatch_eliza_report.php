                 ...
                 <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                     ...
                     <div class="form-group">
                      <div class="input-group">
                      <input type="text" name="donor_hbsag"  autocomplete="off" value="<?php echo $donor_hbsag;?>" class="form-control" placeholder=" Donor HBsAG " >                      </div>
                      <!--<datalist id="hbsag" >-->
                      ...
                      <div class="form-group">
                      <div class="input-group">
                      <input type="text" name="donor_anti_hcv"  autocomplete="off" value="<?php echo $donor_hcv;?>" class="form-control" placeholder=" Anti HCV " >                      </div>
                      <!--<datalist id="hcv" >-->
                      <!--    <option value="Reactive">-->
                      <!--    <option value="Non Reactive">                     -->
                      <!--</datalist>-->
                      ...
                      <div class="form-group">
                      <div class="input-group">
                      <input type="text" name="donor_anti_hiv"  autocomplete="off" value="<?php echo $donor_hiv;?>" class="form-control" placeholder=" Anti HIV " >                      </div>
                      <!--<datalist id="hiv" >-->
                      <!--    <option value="Reactive">-->
                      <!--    <option value="Non Reactive">                     -->
                      <!--</datalist>-->
