...
<head>
  ...
  <title>Product List | <?php echo $basetitle;?></title>
  <!-- General CSS Files -->
...
<th colspan="2">Action</th>
                        ...
                        <tbody>
<?php
$products=mysqli_query($con,"select * from products order by id desc") or die (mysqli_error());
while($info=mysqli_fetch_array($products)){
?>
                          <tr>
<td><?php echo $info['id'];?></td>
<td><img src="../<?php echo $info['path'];?>" width="50px"></td>
<td width="60%"><?php echo $info['title'];?></td>
<td><?php echo $info['price'];?></td>
<td><?php echo $info['delivery_charges'];?></td>
<td width="2%">
<a href="<?php echo $baseurl;?>product/<?php echo $info['id'];?>.html" class="btn btn-info"><i class="fas fa-edit"></i></a>
                            </td>

<td width="2%">
<a href="<?php echo $baseurl;?>remove_product.php?id=<?php echo $info['id'];?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                            </td>
                          </tr>
<?php
}
