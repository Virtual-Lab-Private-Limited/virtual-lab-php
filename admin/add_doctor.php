...
mysqli_query($con,"insert into doctors(firstname,lastname,email,phone,city,clinic,gender,address,education,labid) values ('$firstname','$lastname','$email','$contact','$city','$clinic','$gender','$address','$education','$session_labid')") or die (mysqli_error($con));
