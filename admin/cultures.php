        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12">
           <div class="section-body">
<form method="post" action="<?php echo $baseurl;?>cultures.html">
        <div class="row">
...
<th>Action</th>
                        ...
                        <tbody>
<?php
$tests=mysqli_query($con,"select * from culters order by id") or die (mysqli_error());
...
<td width="25%">
<a href="<?php echo $baseurl;?>add_culture/<?php echo $info['id'];?>.html" class="btn btn-success">Details</a>
<a href="<?php echo $baseurl;?>editculture/<?php echo $info['id'];?>.html" class="btn btn-info">Edit</a>
<a href="<?php echo $baseurl;?>deleteculture.php?id=<?php echo $info['id'];?>" class="btn btn-danger">Delete</a>
                            </td>
                          </tr>
<?php
}
