...
<input type="hidden" name="total_price" id="total_price" value="<?php echo $totalamount;?>">

</td>
</tr>
<tr><td colspan="5"><label>Discount:</label></td>
<td style="width:30px" ><input type="text" name="discount" id="discount" class="form-control"></td>
<td  ><select name="discount_type" id="discount_type" class="form-control">
    <option value="%">%</option>
    <option value="Rs">Rs</option>
</select></td></tr>
<tr><td colspan="5"><label>Total:</label></td>
<td style="width:30px" ><span id="total" ></td>
</tr>
<tr><td colspan="5"><label>Paid:</label></td>
<td style="width:30px" ><input type="text" name="paid" id="paid" class="form-control" required></td>
</tr>
<tr>
<td colspan="4">
