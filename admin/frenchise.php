...
password='$npass ' where id='$uid' limit 1") or die (mysqli_error($con));
...
<head>
  ...
  <title>Frenchise | <?php echo $basetitle;?></title>
  <!-- General CSS Files -->
...
<form action="<?php echo $baseurl;?>change_pass/<?php echo $id;?>.html" method="post"> 
            <div class="row">
