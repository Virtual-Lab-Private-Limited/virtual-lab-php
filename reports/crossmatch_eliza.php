...
if(((float)$donor_hbsag)<1){ 
    $content .= '<td width="20%"><b>Non-Reactive</b></td>'; 
    
} else {
    $content .= '<td width="20%"><b>Reactive</b></td>';
}
...
<tr><th width="20%">Anti HCV</th><td width="20%"><b>';
...
<tr><th width="20%">Anti HIV</th><td width="20%"><b>';
