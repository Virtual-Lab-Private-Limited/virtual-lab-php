<?php
    ...
    while($row=mysqli_fetch_array($results)){
        ...
        if( ! empty( $row['value']) ) {
            $output .= '<tr><td>'.$test_title.'</td><td>'.$row['value'].'</td><td>'.$row['control'].'</td><td>'.$unit.'</td>';
...
$style = array(
    ...
    // $pdf->write1DBarcode($bookingno, 'C39', 92, 70, 20, 10, 0.4, $style, 'N');
    // $pdf->SetXY(95, 80);
 ...
 $content = '';  
    ...
    $content .= ' 
      <table class="table table-md">  
        ...
        <th class="text-left" width="10%" style="font-weight:bold">Control</th>    
