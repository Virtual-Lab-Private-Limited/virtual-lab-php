<?php
    ...
    $results=mysqli_query($con,"select * from  screening_result where bdid='$id' ") or die (mysqli_error());
...
$row3 = '';
 ...
 $content = '';  
      ...
      <table class="table table-md">  
        ...
        <th width="60%" style="font-weight:bold">Test</th>
        <th width="15%" style="font-weight:bold">Result</th> ';
    $row1 .= '
