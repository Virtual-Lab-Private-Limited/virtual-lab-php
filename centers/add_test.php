...
if (isset($_POST['submit'])) {
    ...
    if ($itemValues != 0) {
        ...
        if (!empty($result))
        {
            ...
            values ('$session_id','$caseno','$total','$discount', '$tprice','$earned','$amount_to_pay',now(),'0','$session_labid' ) ") or die(mysqli_error($con));
...
?>
                       ...
                       <div class="input-group mb-3">
                            ...
                            <option value="Collection Center" selected > Collection Center</option>
                            </select>
                          </div>
                          <div class="input-group mb-3">
    <div class="input-group-prepend">
