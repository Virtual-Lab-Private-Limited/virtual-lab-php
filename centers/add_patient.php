...
if(isset($_POST['submit'])){
    ...
    mysqli_query($con,"insert into patients (firstname,lastname,cnic,contact,address,city,dob,age,blood_group,date_entry,gender,labid,addby,parentid, profile, cc_no)
        values('$firstname','$lastname','$cnic','$contact','$address','$city','$dob','$age','$blood_group',now(),'$gender','$session_labid','$session_id','0', 'images/$name', '$session_id')") or die (mysqli_error($con));
