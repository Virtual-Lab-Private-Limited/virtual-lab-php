...
$patients=mysqli_query($con,"select * from investors where id='$id' limit 1") or die (mysqli_error());
...
mysqli_query($con,"update investors set firstname='$fname',lastname='$lname',cnic='$ncnic',contact='$phone',city='$ncity',dob='$dateob',gender='$gen',address='$add' where id='$uid' limit 1") or die (mysqli_error($con));
...
<form action="<?php echo $baseurl;?>investor_info/<?php echo $id;?>.html" method="post"> 
            <div class="row">
