...
mysqli_query($con,"insert into members (cc_no,firstname,lastname,username,email,contact,dob,password,member_type,status,doj,qualification,salary,city,cnic,labid,lati,longi,name,path,payment_method,details)
values('$session_uid','$firstname','$lastname','$username','$email','$contact','$dob','$password','$role','$status','$doj','$qualification','$salary','$city','$cnic','$session_labid','','','N/A','N/A','Not Set','')") or die (mysqli_error($con));
...
<input type="date" class="form-control datemask" placeholder="YYYY/MM/DD" name="dob" value="">
</div>
...
<input type="date" class="form-control datemask" placeholder="YYYY/MM/DD" name="doj" value="">
</div>
                    <div class="form-group">
