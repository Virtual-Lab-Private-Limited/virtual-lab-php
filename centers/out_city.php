...
values('$caseno','$courierno','$date','$time','$contact','$session_address','$session_uid','$session_labid')") or die (mysqli_error($con));
...
<form action="out_city.php" method="post"> 
...
<input type="text" class="form-control" name="courierno" value="" placeholder=" Courier No " required>
                      </div>
                    </div>
...
<input type="date" class="form-control" name="date" value="" placeholder="Expected Delivery Date ">
                      </div>
                    </div>
                  </div>
...
<input type="time" class="form-control" name="time" value="" placeholder="Expected Delivery Time ">
                      </div>
                    </div>
                    <div class="form-group">
<div class="input-group">
...
<div class="form-group" >
    <input type="submit" name="submit" value=" Add Request " class="btn btn-block btn-info">              
...
<td width="14%">
<a href="<?php echo $baseurl;?>delete_outcity_request.php?id=<?php echo $info['id'];?>" class="btn btn-success"><i class="fa fa-trash"></i> Delete</a>
</td>
                          </tr>
<?php
}
